----Energy used to take out the mean and standard deviation, used by re-setting the voltage on PDT1
...
local name = "energyresulthigh-x.csv"
...
adjustable first_tube = 3100 -- RE-SET depending on what PDT1 is analysed!
adjustable second_tube = 3100 -- Re-set this to the same level, will change
adjustable n_particles = 100 -- set amount of ions
adjustable n_charge = 13 -- set the ions' charge
adjustable tau = 0.01 -- DEFAULT 0.01 usec
adjustable n_reruns = 28 -- Amount of reruns
...
-- Creates a energy_splat list for all ions, a new file for every rerun
...
function write_csv(voltage, prec_splat)
    ...
    local file = io.open("voltage2high.csv", "w")
...
function segment.terminate()
    ...
    voltage_2[count] = second_tube  -- voltage on PDT2
