--- Bunchlength as a function voltage when the voltage is kept the same for both tubes, USED FOR DIFFERENT TIME CONSTANTS, DEFAULT SET TO 0.1 USEC
...
adjustable first_tube = 0 -- the voltage on PDT1
adjustable second_tube = 0 -- the voltage on PDT1
adjustable n_particles = 100 -- set number of ions used in simulations
adjustable n_charge = 13 -- charge of ion
adjustable tau = 0.1 -- DEFAULT SET TO 0.1 usec, CHANGE
adjustable n_reruns = 79 -- Amount of reruns
...
-- Bunchlength and voltage on both tubes, gives out one list after each rerun is finished
function write_csv(voltage, bunchlt)
    ...
    local file = io.open("resultbunchlttau0.1.csv", "w")
...
function segment.terminate()
    ...
    voltages[count] = first_tube  -- voltage1 = voltage2 for these simulation!
    ...
    first_tube = first_tube + 50 -- change the voltage each run by 50V
    second_tube = second_tube + 50
